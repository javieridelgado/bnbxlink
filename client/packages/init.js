...
// BNB - J.Delgado - 22 Feb 2015 - BEGIN
// We want the drag to begin only after a long press
function onpress(el, callback, timeout) {
    var timer;
    timeout = timeout || 500;
...
function onlongclick(el, callback, timeout) {
    var timer;
    timeout = timeout || 500;
...
(function (factory) {
    ...
    if (typeof define === "function" && define.amd) {
        ...
        window.Sortable = factory();  // export for Meteor.js
    }
    else {
        /* jshint sub:true */
    ...
    function Sortable(el, options) {
        ...
        // Bind events
        // BNB - J.Delgado - Detect press instead of touch
        //_on(el, 'mousedown', this._onTapStart);
        //_on(el, 'touchstart', this._onTapStart);
        onlongclick(el, this._onTapStart);
        onpress(el, this._onTapStart);
